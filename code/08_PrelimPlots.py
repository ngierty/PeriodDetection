...
plot_h0_extremevals(null_uneven_aov, null_uneven_ls_power, null_uneven_pdm, null_uneven_sl,
                    h1_aov, h1_ls_power, h1_pdm, h1_sl,
                    plots_output, 'Prelim__h0_h1_extreme_hists')
...
plot_h0_periodograms(null_uneven_aov, null_uneven_ls_power, null_uneven_pdm, null_uneven_sl,
                     h1_aov, h1_ls_power, h1_pdm, h1_sl, 
                     plots_output, 'Prelim__h0_h1_periodograms')
