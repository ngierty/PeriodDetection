...
plots_output = path + 'output/SummaryPaperPlots/'
...
# Extreme values histograms for unevenly-spaced observations, heteroscedastic, increasing noise
plot_h1_extremevals(null_hetero_sim_aov, null_hetero_sim_ls_power, null_hetero_sim_pdm, null_hetero_sim_sl,
                    plots_output, 'SummaryPaper__h0_extreme_heteroscedastic_increasing_hists')


# Extreme values histograms for observations under Ha
plot_h0_extremevals(h1_aov, h1_ls_power, h1_pdm, h1_sl,
                    null_uneven_aov, null_uneven_ls_power, null_uneven_pdm, null_uneven_sl,
                    plots_output, 'SummaryPaper__h1_h0_extreme_hists')
